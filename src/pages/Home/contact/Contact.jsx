...
const Contact = () => {
    ...
    return (
        <div id="contact" className="container mx-auto h-full lg:h-[700px] mt-40">
            ...
            <h4 className="text-2xl xl:text-4xl lg:my-5 font-extrabold text-center bg-gradient-to-r from-indigo-700  to-pink-500  bg-clip-text text-transparent">Contact Me</h4>

            <div className="grid grid-cols-1 lg:grid-cols-2 mt-8 gap-5 p-4 lg:p-0">
                <div className="w-full  max-w-lg mx-auto shadow-lg shadow-sky-400/50 rounded-2xl bg-base-100 order-2 lg:order-1">
                    <form ref={form} onSubmit={sendEmail} className="card-body">
                        <h2 className="text-2xl text-center font-bold">Send Message</h2>
                        ...
                        <div className="form-control mt-6">
                            <input type="submit" value="Send" className="cursor-pointer p-1 text-xl text-white rounded-lg font-semibold bg-gradient-to-r  from-pink-500 via-purple-500 to-indigo-500 " />
                        </div>
                    </form>
                </div>

                <div className="w-full lg:w-2/3 mx-auto order-1 lg:order-2" >

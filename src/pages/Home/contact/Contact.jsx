...
const Contact = () => {
    ...
    return (
        <div id="contact" className="container mx-auto h-full lg:h-[700px] mt-40">
            ...
            <h4 className="text-3xl xl:text-5xl lg:my-5 font-extrabold text-center bg-gradient-to-r from-indigo-700  to-pink-500  bg-clip-text text-transparent">Contact Me</h4>

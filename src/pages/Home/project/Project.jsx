    ...
    return (
        <div className="my-5 p-2">
            ...
            <div className="text-center my-10">
                <Link to="/" className="p-1 md:p-2 text-md text-white rounded-lg font-semibold bg-gradient-to-r  from-pink-500 via-purple-500 to-indigo-500 ">Go Back To Home Page</Link>
            </div>
        </div>
    );
};

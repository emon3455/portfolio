            ...
            <div className="flex lg:justify-center lg:items-center flex-col lg:flex-row gap-10">
                ...
                <div className="w-full lg:w-2/3">
                    ...
                    <div className="space-y-4 mb-4">
                        <h2 className="text-center text-5xl font-extrabold bg-gradient-to-r  from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent ">About Me</h2>
                    ...
                    <div className="">
                        <Tabs>
                            <TabList>
                                <Tab>
                                    <span className='text-2xl bg-gradient-to-r  from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent font-extrabold border-0 hover:border-b-4 hover:border-violet-500 transition-all'>Education</span>
                                </Tab>
                                <Tab>
                                    <span className='text-2xl text-violet-600 font-extrabold border-0 hover:border-b-4 hover:border-violet-500 transition-all'>Experience</span>
                                </Tab>
                                <Tab>
                                    <span className='text-2xl bg-gradient-to-r  from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent font-extrabold border-0 hover:border-b-4 hover:border-violet-500 transition-all'>Achivements</span>
                                </Tab>
                            </TabList>
